  ...
  const products = [
    {
      ...
      additionalImages: [
        'https://i.postimg.cc/dV03DDbN/Whats-App-Image-2026-07-24-at-10-08-29-AM-(3).jpg',
      ],
    ...
    },
    {
      ...
      additionalImages: ['https://i.postimg.cc/wjBM33Ch/Whats-App-Image-2026-07-24-at-10-05-27-AM.jpg'],
    ...
    },
    {
      ...
      additionalImages: ['https://i.postimg.cc/QdMCVV2n/Whats-App-Image-2026-07-24-at-10-11-38-AM.jpg'],
    ...
    },
    {
      ...
      safetyInfo: 'Ideal para masajes Shantala desde los 2 meses de edad.',
      inStock: true,
      isFeatured: true,
      sortOrder: 4,
    },
    {
      ...
      safetyInfo: 'Libre de sulfatos (SLS/SLES), parabenos y colorantes artificiales.',
      inStock: true,
      isFeatured: true,
      sortOrder: 5,
    },
    {
      ...
      description:
        'El regalo y aliado perfecto para mamás. Incluye Pañitos Húmedos, Colonia, Crema Corporal y Bálsamo de Sueño a un precio especial con bolsa organizadora de regalo.',
      benefits: [
      ...
      safetyInfo: 'Apto desde el nacimiento. Hipoalergénico y probado por pediatras.',
      inStock: true,
      isFeatured: true,
      sortOrder: 6,
    },
