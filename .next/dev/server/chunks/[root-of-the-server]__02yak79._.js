...
"[project]/src/app/api/v1/tips/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    let tips = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_TIPS"]
    ];
    ...
    if (query) {
        ...
        tips = tips.filter((t)=>t.title.toLowerCase().includes(q) || t.summary.toLowerCase().includes(q));
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02yak79._.js.map